...
```{r, label = chart5, echo = FALSE, fig.cap = "ROC Curve for Random Forest", fig.height = 4}
thresholds <- seq(1, 0, -0.01)
TPR_vec <- rep(NA, length(thresholds))
FPR_vec <- rep(NA, length(thresholds))
